...
def update_project_changelogs() -> None:
    """Update changelogs for all main packages in the project."""
    results = ChangelogUtil.update_project_changelogs()
