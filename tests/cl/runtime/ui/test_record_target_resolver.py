...
def test_record_value_update(default_db_fixture, type_info_fixture):
    ...
    resolver = RecordTargetResolver(key="test_id", type_name="StubInteractiveRecord")
...
def test_record_resolve_not_interactive(default_db_fixture, type_info_fixture):
    ...
    resolver = RecordTargetResolver(key="test_id", type_name="StubNonInteractiveRecord")
    em = EventManager(resolver=resolver)
    events = em.dispatch(
        {
            "_t": "ValueUpdateEvent",
...
def test_record_resolve_missing_key(default_db_fixture, type_info_fixture):
    ...
    resolver = RecordTargetResolver(key="nonexistent", type_name="StubInteractiveRecord")
    em = EventManager(resolver=resolver)
    events = em.dispatch(
        {
            "_t": "ValueUpdateEvent",
