...
class ValueUpdateEventHandler(UiEventHandler[ValueUpdateEvent]):
    def process(self, target: Control | InteractiveMixin, event: ValueUpdateEvent) -> list[UiEvent]:
        ...
        return target.update_value(snake_case_field, value)
