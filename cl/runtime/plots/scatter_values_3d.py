...
class ScatterValues3D(DataclassMixin):
    ...
    """Line style for rendering the points as a connected polyline (use NaN coordinates to break segments)."""
    ...
    def __init(self) -> None:
        ...
        if self.marker_style is None and self.line_style is None and self.surface_style is None:
            # Default to circle marker if none of the styles is specified
